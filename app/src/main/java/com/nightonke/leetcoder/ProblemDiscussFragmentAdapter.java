 ...
 */
public class ProblemDiscussFragmentAdapter
        extends RecyclerView.Adapter<ProblemDiscussFragmentAdapter.ViewHolder> {

    private Context mContext;
    private ArrayList<Discuss> discusses;
    private OnItemClickListener onItemClickListener;

    public ProblemDiscussFragmentAdapter(ArrayList<Discuss> discusses, OnItemClickListener onItemClickListener) {
